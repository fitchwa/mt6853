...
static bool usbc_otg_status = false;
#endif
...
extern void hct_otg_gpio_set(bool en);
#endif
#endif
...
#ifdef __HCT_WIRELESS_CHARGER_WHEN_TPC_IN_SUPPORT__
		usbc_otg_status = false;
#endif
#ifdef __HCT_OTG_GPIO_SELECT__
       #if __HCT_OTG_GPIO_SELECT__
		hct_otg_gpio_set(false);
#endif
#endif
...
#ifdef __HCT_WIRELESS_CHARGER_WHEN_TPC_IN_SUPPORT__
bool usbc_otg_state_get(void)
{
       return usbc_otg_status;
}
#endif
