		...
		const char *buf, size_t size)
{
	...
	//mt6360_set_scenario(2); //chenyichong moved to bottom.
...
#ifdef CONFIG_MT6360_PMU_FLED
	mt6360_set_scenario(2); //chenyichong moved after set_driver or else will be replaced.
#endif
