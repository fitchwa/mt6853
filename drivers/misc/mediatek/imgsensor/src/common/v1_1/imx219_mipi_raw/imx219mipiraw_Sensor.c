...
static struct imgsensor_info_struct imgsensor_info = { 
	...
	.exp_step = 2,
	.gain_step = 1,
	.gain_type = 0,//0:Sony  1:OV  2:Samsung  3:Hinyx  4:GC
...
{{ 3280, 2464,	0, 	0, 3280, 2464, 1640, 1232, 0, 0, 1640, 1232,	0,	0, 1640,  1232}, // Preview 
 ...
 //{ 3280, 2464,	0,	0, 3280, 2464, 3280, 2464, 0, 0, 3280, 2464,	4,	4, 3264, 2448}, // capture1 
 { 3280, 2464,	0,	0, 3280, 2464, 3280, 2464, 0, 0, 3280, 2464,	0,	0, 3280, 1846},  // video 
 { 3280, 2464,	0,  0, 3280, 2464, 3280, 2464, 0, 0, 1920, 1080,	0,	0, 1920, 1080}, //hight speed video 
 { 3280, 2464,	0,  0, 3280, 2464, 1640, 1232, 0, 0, 1640,  926,	0,	0, 1280,  720}};// slim video 
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x0172,  0x00);//00  //edit by wming for mirror
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	preview_setting();
#if 0//def LYCONFIG_EXCHANGE_BACK_FRONT_CAMERA_SUPPORT
...
static kal_uint32 set_max_framerate_by_scenario(enum MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate) 
{
	...
	LOG_INF("scenario_id = %d, framerate = %d frame_length = %d shutter = %d\n", scenario_id, framerate,imgsensor.frame_length,imgsensor.shutter);
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable)
	{
		...
		{
			msleep(10);
			printk("hct-drv %s is enable !",__func__);			
		};
#endif
	}
	else
