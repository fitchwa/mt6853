...
#define LOG_1 LOG_INF("S5K3P9SP,MIPI 4LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3P9SP_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =
{
 ...
 { 4640, 3488, 1040, 1024, 2560, 1440, 1280,  720, 0,	0, 1280,  720, 0, 0, 1280,  720}, //hight speed video
...
static void preview_setting(void)
{
  ...
  write_cmos_sensor(0x0340, 0x0743);
  write_cmos_sensor(0x0342, 0x2734);
...
static void hs_video_setting(void)
{
  ...
  write_cmos_sensor(0x0346, 0x0408);
  write_cmos_sensor(0x0348, 0x0E1F);
  write_cmos_sensor(0x034A, 0x09A7);
  ...
  write_cmos_sensor(0x030C, 0x0000);
  write_cmos_sensor(0x030E, 0x0004);
  write_cmos_sensor(0x0310, 0x00A0);
  write_cmos_sensor(0x0312, 0x0001);
...
static void slim_video_setting(void)
{
  ...
  write_cmos_sensor(0x0348, 0x108F);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			...
			//S5K3P9SP_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;
        /******************** PDAF END   <<< *********/
        default:
            break;
