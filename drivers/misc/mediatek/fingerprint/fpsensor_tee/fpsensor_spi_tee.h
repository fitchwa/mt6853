...
#define FP_DEFAULT_SPI_SPEED       (1 * 1000 * 1000)
/*********************** debug log setting **********************/ 
...
//#define FPSENSOR_SPI_CLOCK_TYPE    FPSENSOR_SPI_CLOCK_TYPE_CLK

//#else
#define FPSENSOR_SPI_CLOCK_TYPE    FPSENSOR_SPI_CLOCK_TYPE_MASTER_CLK
...
// 
// dts node 
#define FPSENSOR_DTS_NODE            "ontim,fingerprint"   

// compatible node 
#define FPSENSOR_COMPATIBLE_NODE     "mediatek,chipone_fp"
