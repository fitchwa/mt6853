...
static int parse_dt(struct device *dev, struct synaptics_dsx_board_data *bdata)
{
	...
	hct_synaptics_debug("%s  line: %d. bdata->irq_gpio = %d. bdata->irq_flags = %ld. \n", __func__, __LINE__, bdata->irq_gpio, bdata->irq_flags);
	...
	hct_synaptics_debug("%s  line: %d. bdata->power_gpio = %d. \n", __func__, __LINE__, bdata->power_gpio);
	...
	hct_synaptics_debug("%s  line: %d. bdata->reset_gpio = %d. \n", __func__, __LINE__, bdata->reset_gpio);
	...
	hct_synaptics_debug("%s  line: %d. bdata->ub_i2c_addr = %d. \n", __func__, __LINE__, bdata->ub_i2c_addr);
