...
#define CONFIG_SYNAPTICS_DEBUG
#ifdef CONFIG_SYNAPTICS_DEBUG
#define hct_synaptics_debug(fmt, args...)	printk(KERN_ERR "hct-drv: " fmt, ## args)
#else
#define hct_synaptics_debug(fmt, args...)
#endif
